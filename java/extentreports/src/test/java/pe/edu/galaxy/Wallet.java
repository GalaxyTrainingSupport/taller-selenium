...
public class Wallet {
	...
	public void beforeClass() {
		...
		System.setProperty("webdriver.gecko.driver",
				"/Users/lruiz/eclipse-workspace/TestinNG/src/test/resources/drivers/geckodriver");
	...
	public void setCredential() throws InterruptedException {
        ...
        Assert.assertEquals("selenium", driver.findElement(By.xpath("/html/body/div[2]/div/div/div/div/h4")).getText());
	...
	public void failLogin() throws InterruptedException {
		...
		String actualMessage = driver.findElement(By.cssSelector("body > div:nth-child(2) > div > div > div")).getText();
